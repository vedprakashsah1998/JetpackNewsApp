...
val isDarkThemeActive = MutableStateFlow(false)
...
fun SampleNewsAppTheme(
    ...
    isDarkThemeActive.tryEmit(useDarkTheme)
    val appColorScheme = if (useDarkTheme) darkColorScheme else lightColorScheme
